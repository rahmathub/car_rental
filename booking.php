<?php
    ...
    {
        echo '<script>alert("Silahkan mendaftar dulu untuk Menjadi member rental mobil !");window.location="index.php"</script>';
    }
    $id = $_GET['id'];
           ...
           <div class="card-body">
               <form method="post" action="koneksi/proses.php?id=booking">
                    <div class="form-group">
                      <input type="hidden" name="ktp" id="" required class="form-control" value="1234567890">
                    </div> 
                    <div class="form-group">
